...
const i18n: I18nData = {
  zh: {
    ...
    contentEditorLabel: "Content 編輯器", contentEditorNew: "新增 Content", contentEditorEdit: "編輯 Content", contentEditorDelete: "刪除 Content",
    contentEditorNoData: "尚無 Content，點擊「新增 Content」開始設計。",
    ...
    nginxDisabled: "停用", nginxSiteStatus: "狀態",
    nginxCustomConfig: "自訂 Config（留空自動產生）",
    nginxSaveSite: "儲存網站", nginxPreviewSite: "預覽設定", nginxWriteSite: "寫入設定檔",
    nginxRemoveSiteFile: "移除設定檔", nginxWriteTestReload: "寫入後測試並 Reload",
    nginxDeleteSite: "刪除", nginxSiteList: "網站列表",
    ...
    nginxSiteFileWritten: "設定檔已寫入", nginxSiteFileRemoved: "設定檔已移除",
    nginxWriteTestReloadDone: "寫入、測試、Reload 完成",
    nginxModuleAdded: "模組已新增", nginxModuleToggled: "模組狀態已切換",
    kyklosHaLabel: "Kyklos HA", haproxyLabel: "HAProxy 管理", haproxyStatus: "HAProxy 狀態", haproxyWeb: "Web 負載平衡",
  ...
  en: {
    ...
    contentEditorLabel: "Content Designer", contentEditorNew: "New Content", contentEditorEdit: "Edit Content", contentEditorDelete: "Delete Content",
    contentEditorNoData: "No content yet. Click \"New Content\" to start designing.",
    ...
    nginxReload: "Reload", nginxStart: "Start", nginxStop: "Stop", nginxRestart: "Restart",
    ...
    nginxDisabled: "Disabled", nginxSiteStatus: "Status",
    nginxCustomConfig: "Custom Config (leave blank to auto-generate)",
    nginxSaveSite: "Save Site", nginxPreviewSite: "Preview Config", nginxWriteSite: "Write Config File",
    nginxRemoveSiteFile: "Remove Config File", nginxWriteTestReload: "Write, Test & Reload", nginxDeleteSite: "Delete",
    ...
    nginxReloadSuccess: "Nginx reloaded", nginxSiteFileWritten: "Config file written",
    nginxSiteFileRemoved: "Config file removed", nginxWriteTestReloadDone: "Write, test and reload completed",
    nginxModuleAdded: "Module added", nginxModuleToggled: "Module toggled",
    kyklosHaLabel: "Kyklos HA", haproxyLabel: "HAProxy Management", haproxyStatus: "HAProxy Status", haproxyWeb: "Web Load Balance",
  ...
  ja: {
    ...
    zero: "ゼロ",
    zeroCounters: "カウンタをゼロ", edit: "編集", delete: "削除", refresh: "更新", refreshSuccess: "更新完了",
    ...
    contentEditorLabel: "コンテンツエディタ", contentEditorNew: "新規コンテンツ", contentEditorEdit: "コンテンツ編集", contentEditorDelete: "コンテンツ削除",
    contentEditorNoData: "コンテンツがありません。「新規コンテンツ」をクリックして作成してください。",
    ...
    nginxTest: "設定テスト", nginxReload: "再読み込み", nginxStart: "起動", nginxStop: "停止", nginxRestart: "再起動",
    ...
    nginxDisabled: "無効", nginxSiteStatus: "状態",
    nginxCustomConfig: "カスタム Config（空欄で自動生成）",
    nginxSaveSite: "サイトを保存", nginxPreviewSite: "設定をプレビュー", nginxWriteSite: "設定ファイルを書き込み",
    nginxRemoveSiteFile: "設定ファイルを削除", nginxWriteTestReload: "書き込み後テストして Reload", nginxDeleteSite: "削除",
    nginxSiteList: "サイト一覧",
    ...
    nginxReloadSuccess: "Nginx を再読み込みしました", nginxSiteFileWritten: "設定ファイルを書き込みました",
    nginxSiteFileRemoved: "設定ファイルを削除しました", nginxWriteTestReloadDone: "書き込み、テスト、Reload が完了しました",
    nginxModuleAdded: "モジュールを追加しました", nginxModuleToggled: "モジュール状態を変更しました",
    kyklosHaLabel: "Kyklos HA", haproxyLabel: "HAProxy 管理", haproxyStatus: "HAProxy 状態", haproxyWeb: "Web ロードバランス",
