export default function JuniperView() {
  return (
    <div id="juniperView" className="network-tool-view" style={{ display: 'none' }}>
          ...
          <div className="card">
            ...
            <div className="card-body juniper-form">
              ...
              <div className="row g-3">
                ...
                <div className="col-xl-6 col-12 d-flex align-items-end">
        ...
        <div className="tab-pane fade" id="juniperPortPane" role="tabpanel">
          <div className="card">
            ...
            <div className="card-body">
              ...
              <div className="juniper-bulk-panel juniper-form border-top pt-2">
                <div className="juniper-bulk-fields">
                  <div className="juniper-bulk-field">
                ...
                <div className="juniper-bulk-selected">
                  <div className="juniper-bulk-selected-label">已選取 Port</div>
                  <div className="juniper-selected-ports" id="juniperSelectedPorts"></div>
                </div>
                <div className="juniper-bulk-actions">
                  <button className="btn btn-primary" id="juniperBulkApply"><i className="bx bx-check me-1"></i><span id="juniperBulkApplyLabel">套用至選取 Port</span></button>
                </div>
              </div>
